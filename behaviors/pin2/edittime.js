...
{
	return {
		"name":			"Pin2",					// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"Pin2",					// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",
...
AddComboParam("Destroy If Unpined", "Destroy if unpined");
AddAction(2, af_none, "Destroy if UnPin", "", "{my} Unpin {0}", "Destroy if UnPin", "DestroyIfUnPin");
AddComboParamOption("Position & angle");
AddComboParamOption("Position only");
AddComboParamOption("Angle only");
AddComboParamOption("Rope style");
AddComboParamOption("Bar style");
AddComboParam("Mode", "Choose which properties of the object to update.");
AddAction(3, af_none, "Change Mode", "", "{my} Change Mode {0}", "Change Mode", "ChangeMode");
...
var property_list = [
  new cr.Property(ept_combo, "Destroy when if unpined", "No", "Destroy the object bounce when if unpined", "No|Yes")
	];
