...
/////////////////////////////////////
// Behavior class
cr.behaviors.Pin2 = function(runtime)
{
...
(function ()
{
	var behaviorProto = cr.behaviors.Pin2.prototype;
	...
	{
	    this.destroyifunpin = (this.properties[0] !== 0);
		this.pinObject = null;
	...
	Acts.prototype.DestroyIfUnPin = function (unpinned)
	{
		this.destroyifunpin = (unpinned !== 0);
	};
	Acts.prototype.ChangeMode = function (mode_)
	{
		this.mode = mode_;
	};
